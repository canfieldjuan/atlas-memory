#!/usr/bin/env python3
"""
Google Gmail OAuth Setup Script

Run this script to get a refresh token for the Atlas Gmail digest task.
...
6. Download or copy the Client ID and Client Secret
   (You can reuse the same OAuth client from calendar setup)

Usage:
    python scripts/setup_google_gmail.py

Then add to your .env or environment:
    ATLAS_TOOLS_GMAIL_ENABLED=true
    ATLAS_TOOLS_GMAIL_CLIENT_ID=<your_client_id>
    ATLAS_TOOLS_GMAIL_CLIENT_SECRET=<your_client_secret>
    ATLAS_TOOLS_GMAIL_REFRESH_TOKEN=<output_from_this_script>
"""
...
def main():
    print("=" * 60)
    print("Google Gmail OAuth Setup for Atlas")
    print("=" * 60)
    print()
    print("Note: You can reuse the same OAuth Client ID/Secret")
    print("from your calendar setup. Gmail needs a separate")
    print("refresh token for the gmail.readonly scope.")
    print()
